package com.codelexer.springcloudawsses.services;
...
public class EmailService {
    ...
    public void sendTemplateMessageWithAttachment(SimpleMailMessage simpleMailMessage) {
        ...
        try {
            ...
            model.put("Name", "Codelexer Admin");
            model.put("location", "Lahore, Pakistan");
    ...
    public void sendTemplatedMessage(SimpleMailMessage simpleMailMessage) {
        ...
        templatedEmailRequest.withTemplateData("{ \"name\":\"Codelexer Admin\", \"location\": \"Lahore, Pakistan\"}");
